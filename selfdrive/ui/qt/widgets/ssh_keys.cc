...
AebSelect::AebSelect() : AbstractControl("AEB [√]", "Select the signal AEB. (Scc12/Fca11)", "../assets/offroad/icon_aeb.png") {
  label.setAlignment(Qt::AlignVCenter|Qt::AlignRight);
  label.setStyleSheet("color: #e0e879");
  hlayout->addWidget(&label);
...
LongControlSelect::LongControlSelect() : AbstractControl("LongControl [√]", "LongControl Choose a mode. (Mad/Mad+Long)", "../assets/offroad/icon_long.png") {
  label.setAlignment(Qt::AlignVCenter|Qt::AlignRight);
  label.setStyleSheet("color: #e0e879");
  hlayout->addWidget(&label);
