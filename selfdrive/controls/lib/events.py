...
class StartupAlert(Alert):
  def __init__(self, alert_text_1: str, alert_text_2: str = "Always hold the steering wheel and keep an eye on the road", alert_status=AlertStatus.normal):
    super().__init__(alert_text_1, alert_text_2,
